...
<form class="text-start form-selecao-data" method="post">
    <div class="container" style="width: auto;">
        <div class="row data-referencia">
            <svg xmlns="http://www.w3.org/2000/svg" width="37" height="37"
                 fill="currentColor" class="bi bi-calendar-month-fill col-sm-1" viewBox="0 0 16 16"
                 style="">
            ...
            <div class="col-sm-1">
                <select class="form-control selecao-mes text-light text-center" name="mes_referencia">
            ...
            <input class="rounded-2 form-control selecao-ano text-light col-sm-1" style="width: 8%;"
